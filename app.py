...
def ifDoneAreaClick():
    ...
    areaSqimgpic.pack_forget() 
    areaRectimgpic.pack_forget()
    areaSphereimgpic.pack_forget()
    areaConeimgpic.pack_forget()
    areaCircleimgpic.pack_forget()
    areaTrapimgpic.pack_forget()
    areaTriimgpic.pack_forget()
    areaRhomimgpic.pack_forget()
    areaPolyimgpic.pack_forget()
